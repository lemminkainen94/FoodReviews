...
parser.add_argument(
    "--city", type=str, default="Sopot", help="the city you want to eat in"
)
parser.add_argument(
    "--mode",
    type=str,
    default="normal",
    help="Two possible modes:\n"
...
parser.add_argument(
    "--top", type=int, default=10, help="How many top results you wish to receive"
)
...
res = requests.post(
    url,
    json={"food": args.food, "city": args.city, "mode": args.mode, "top_res": args.top},
)
if res.ok:
